...
public class VentiladorDialog extends Dialog {
    ...
    public VentiladorDialog (Context context){
        super(context);
        this.context=context;


        setContentView(R.layout.dialog_atritubos_ventilador);
    ...
    public void setTextTemperatura(String text){
        textTemperatura.setText(text+" v");
    }
